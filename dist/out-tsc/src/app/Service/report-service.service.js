...
var ReportServiceService = /** @class */ (function () {
    function ReportServiceService(http, loading, toast) {
        this.http = http;
        this.loading = loading;
        this.toast = toast;
        this.host = 'http://ezlearnapp.test/api';
    }
    ReportServiceService.prototype.searchReports = function (data) {
        return this.http.post(this.host + "/login", data);
    };
    ReportServiceService.prototype.getTaskName = function (data) {
        return this.http.post(this.host + "/getTaskname", { type: data });
    };
    ReportServiceService.prototype.getoptions = function (data) {
        return this.http.post(this.host + "/getTaskoption", { option: data });
    };
    ReportServiceService.prototype.getReports = function (data) {
        return this.http.post(this.host + "/getReport", { report: data });
    };
    ReportServiceService.prototype.getReportAdmin = function (data) {
        return this.http.post(this.host + "/getReportAdmin", { report: data });
    };
    ReportServiceService.prototype.getDate = function (data) {
        return this.http.post(this.host + "/getDate", { date: data });
    };
    ReportServiceService.prototype.getreportcon_view = function (data) {
        return this.http.post(this.host + "/getReportcon_view", { report: data });
    };
    ReportServiceService.prototype.getStudent = function () {
        return this.http.get(this.host + "/getstudent");
    };
    ReportServiceService.prototype.createLoader = function (message) {
    ...
    ReportServiceService.prototype.createToast = function (e, position, timeout) {
