...
var LoginPage = /** @class */ (function () {
    function LoginPage(platform, splashScreen, statusBar, network, navCtrl, menuController, toast, router, storage, event) {
    ...
    LoginPage.prototype.loginData = function (data) {
        var _this = this;
        ...
        this.network.login(this.form).subscribe(function (res) {
            console.log(res);
            if (res.success == true) {
                _this.presentToast();
                ...
                _this.event.publish('user:loggedIn', res.data.type);
    ...
    LoginPage.prototype.presentToastFailed = function () {
        return __awaiter(this, void 0, void 0, function () {
            var toast;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    LoginPage.prototype.Invalidlogin = function () {
        return __awaiter(this, void 0, void 0, function () {
            var toast;
            return __generator(this, function (_a) {
                switch (_a.label) {
