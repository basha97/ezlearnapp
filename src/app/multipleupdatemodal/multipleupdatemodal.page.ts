...
@Component({
  selector: 'app-multipleupdatemodal',
  templateUrl: './multipleupdatemodal.page.html',
  styleUrls: ['./multipleupdatemodal.page.scss'],
})
export class MultipleupdatemodalPage implements OnInit {
public form :any = {};
